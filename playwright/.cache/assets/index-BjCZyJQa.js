const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/QuickActions-BKU3iLLg.js","assets/jsx-runtime-DON3RrwB.js","assets/HeroCarousel-k0BGj2Nb.js"])))=>i.map(i=>d[i]);
...
const C__Users_kavit_Automation_K11tech_K11TechLab_playwright_javascript_ai_augmented_framework_components_QuickActions_jsx = () => __vitePreload(() => import('./QuickActions-BKU3iLLg.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.default);
const C__Users_kavit_Automation_K11tech_K11TechLab_playwright_javascript_ai_augmented_framework_components_HeroCarousel_jsx = () => __vitePreload(() => import('./HeroCarousel-k0BGj2Nb.js'),true              ?__vite__mapDeps([2,1]):void 0).then((mod) => mod.default);
__pwRegistry.initialize({ C__Users_kavit_Automation_K11tech_K11TechLab_playwright_javascript_ai_augmented_framework_components_QuickActions_jsx,
  C__Users_kavit_Automation_K11tech_K11TechLab_playwright_javascript_ai_augmented_framework_components_HeroCarousel_jsx });

export { getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-BjCZyJQa.js.map
